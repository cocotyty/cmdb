...
func main() {
	...
	tablesInfo, err := mtables.GenerateTablesInfo("table", "DeleteTime", model.ObjectRelation{}, model.ObjectRelationMetaValue{})
	if err != nil {
		panic(err)
	}
	data, err := mtables.Render(tablesInfo, "relations", mtables.Plugin{
		Template: cdcTPL,
